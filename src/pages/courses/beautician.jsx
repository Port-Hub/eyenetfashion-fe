        ...
        <div className="flex flex-col">
          <div>
            ...
            <div className="prose-lg">
              ...
              grooming in the past years as more and more people have started to
              go to Beauty Parlours & Spas to enhance their appearance
              <br />
              <br />
              <div>
                The Art of Beauty & Cosmetology has helped many ordinary women
                to become beautiful and thereby boosting their confidence and
                career. In recent years there has been an increase in the number
                of beauty parlour all over the country. This created a demand
                for beauticians who have completed any Beauty parlour courses,
                Cosmetology courses, Beauty Therapist courses, or Hair and
                Beauty courses from a reputed Institute for Beautician courses
                <br />
              </div>
              <br />
              ...
              offering Beautician courses in Tamil Nadu, karnataka & kerala at
              affordable fees for all segments of people. NCFT Heights is the
              best Training Centre for Beautician Courses with well trained
              faculty and up to date study materials. At NCFT Heights we offer
              different beauty related courses like Certificate Courses for
              Bridal Make up , Cosmetology Courses, Beauty care Courses, Beauty
              Short term Courses , Beauty Therapist Courses , and Hair & Beauty
              Courses . By completing any of these courses one can either take
              up a job with a reputed beauty salon and spa or Start their own
              Beautician institute and provide employment to others. Being a
              Career in Beautician is a respectable profession with a very high
              earnings.
              <br />
            </div>
